    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex flex-col justify-center items-center p-4">
             <div className="flex items-center space-x-2 mb-8">
              ...
              <h1 className="text-3xl font-bold text-gray-800 dark:text-white">PriceBeacon</h1>
            </div>

            <div className="w-full max-w-sm bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-8 space-y-6">
                <div>
                    <h2 className="text-xl font-bold text-center text-gray-900 dark:text-white">Sign in to your account</h2>
                    <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
                        Monitor your competitors with ease.
                    </p>
                </div>
                    ...
                    <div>
                        ...
                        <div className="mt-1">
                            <input
                                ...
                                autoComplete="email"
                                required
                                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100"
